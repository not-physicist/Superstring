...
\begin{enumerate}[label=(\alph*)]
	...
	\item The action is invariant under reparametrization transformation $\sigma^\alpha \mapsto \sigma'^\alpha (\sigma^\beta)$. $X^\mu$ is a world-sheet scalar (thus $\partial_\mu = \nabla_\mu$ for $X^\nu$), $h_{\alpha\beta}$ is a tensor.
		...
		\begin{align}
			S_p \mapsto S'_p 
			% &= - \frac{T}{2} \int \dd[2]{\sigma'} \sqrt{-h}  h_{\rho\sigma} \pdv{\sigma^\rho}{\sigma'^\alpha} \pdv{\sigma^\sigma}{\sigma'^\beta} \pdv{\sigma'^\nu}{\sigma^\tau} \partial'_\alpha X^\tau \pdv{\sigma'^\mu}{\sigma^\omega} \partial'_\beta X^\omega \eta_{\mu\nu} \notag \\
